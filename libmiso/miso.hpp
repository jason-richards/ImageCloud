...
void SetLatitude        (MisoPtr context, const std::string& latitude);
void GetLatitude        (MisoPtr context, std::string& latitude);
void SetLongitude       (MisoPtr context, const std::string& longitude);
void GetLongitude       (MisoPtr context, std::string& longitude);
